...
public class PredictService {
    ...
    public void init() throws Exception {
        ...
        // Definir atributos (debe ser igual al ARFF de entrenamiento)
    ...
    public List<Map<String, Object>> predecirCancelaciones() throws Exception {
        ...
        for (Encuesta enc : encuestas) {
            ...
            // Debug: Si algún categórico es -1, se muestra en consola
    ...
    private String getCategoria(Encuesta enc, int idx) {
        switch (idx) {
            case 1:
                return enc.getGenero();
            case 4:
                return enc.getObjetivo();
            case 5:
                return enc.getPlan_membresia();
            case 6:
                return enc.getHa_asistido_ultima_semana();
            case 7:
                return enc.getUsa_entrenador_personal();
            case 8:
                return enc.getAsiste_clases_grupales();
            case 11:
                return enc.getLesiones_recientes();
            case 14:
                return enc.getTiene_descuento();
            default:
                return "";
        }
    }
